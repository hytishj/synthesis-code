set moduleName overlay_fea_Pipeline_1
set isTopModule 0
...
set C_modelName {overlay_fea_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ sext_ln43 int 62 regular  }
	{ buff float 32 regular {array 2000 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "data","offset": { "type": "dynamic","port_name": "data","bundle": "control"},"direction": "READONLY"}]}]} , 
...
set portList { 
	...
	{ buff_address0 sc_out sc_lv 11 signal 2 } 
...
set Spec2ImplPortList { 
	...
	buff { ap_memory {  { buff_address0 mem_address 1 11 }  { buff_ce0 mem_ce 1 1 }  { buff_we0 mem_we 1 1 }  { buff_d0 mem_din 1 32 } } }
}
