...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("length_r", 32, hls_in, 2, "ap_none", "in_data", 1),
	Port_Property("kSQI", 32, hls_out, 3, "ap_vld", "out_data", 1),
	Port_Property("kSQI_ap_vld", 1, hls_out, 3, "ap_vld", "out_vld", 1),
...
const char* HLS_Design_Meta::dut_name = "overlay_fea";
