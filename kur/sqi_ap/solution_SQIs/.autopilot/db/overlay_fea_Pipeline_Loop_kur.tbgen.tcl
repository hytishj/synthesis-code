set moduleName overlay_fea_Pipeline_Loop_kur
set isTopModule 0
...
set C_modelName {overlay_fea_Pipeline_Loop_kur}
set C_modelType { void 0 }
set C_modelArgList {
	{ trunc_ln1 int 31 regular  }
	{ buff float 32 regular {array 2000 { 1 3 } 1 1 }  }
	{ div_i_i float 32 regular  }
	{ m4_out float 32 regular {pointer 1}  }
	{ m2_out float 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "trunc_ln1", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "div_i_i", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "m4_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "m2_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ buff_address0 sc_out sc_lv 11 signal 1 } 
	{ buff_ce0 sc_out sc_logic 1 signal 1 } 
	{ buff_q0 sc_in sc_lv 32 signal 1 } 
	{ div_i_i sc_in sc_lv 32 signal 2 } 
	{ m4_out sc_out sc_lv 32 signal 3 } 
	{ m4_out_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ m2_out sc_out sc_lv 32 signal 4 } 
	{ m2_out_ap_vld sc_out sc_logic 1 outvld 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buff_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "buff", "role": "address0" }} , 
 	...
 	{ "name": "div_i_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "div_i_i", "role": "default" }} , 
 	{ "name": "m4_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "m4_out", "role": "default" }} , 
 	{ "name": "m4_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "m4_out", "role": "ap_vld" }} , 
 	{ "name": "m2_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "m2_out", "role": "default" }} , 
 	{ "name": "m2_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "m2_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "overlay_fea_Pipeline_Loop_kur",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "10017", "EstimateLatencyMax" : "10017",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "div_i_i", "Type" : "None", "Direction" : "I"},
			{"Name" : "m4_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "m2_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
			{"Name" : "Loop_kur", "PipelineType" : "UPC",
...
set ArgLastReadFirstWriteLatency {
	overlay_fea_Pipeline_Loop_kur {
		...
		div_i_i {Type I LastRead 0 FirstWrite -1}
		m4_out {Type O LastRead -1 FirstWrite 15}
		m2_out {Type O LastRead -1 FirstWrite 15}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "10017", "Max" : "10017"}
	, {"Name" : "Interval", "Min" : "10017", "Max" : "10017"}
]}
...
set Spec2ImplPortList { 
	...
	buff { ap_memory {  { buff_address0 mem_address 1 11 }  { buff_ce0 mem_ce 1 1 }  { buff_q0 mem_dout 0 32 } } }
	div_i_i { ap_none {  { div_i_i in_data 0 32 } } }
	m4_out { ap_vld {  { m4_out out_data 1 32 }  { m4_out_ap_vld out_vld 1 1 } } }
	m2_out { ap_vld {  { m2_out out_data 1 32 }  { m2_out_ap_vld out_vld 1 1 } } }
}
