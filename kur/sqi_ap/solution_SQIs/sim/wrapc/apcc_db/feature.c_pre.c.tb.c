...
void overlay_fea_hw_stub(float *llvm_cbe_data, signed int llvm_cbe_length, float *llvm_cbe_kSQI);
void apatb_overlay_fea_sw(float *llvm_cbe_data, signed int llvm_cbe_length, float *llvm_cbe_kSQI);
void apatb_overlay_fea_ir(float *, signed int , float *);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = sitofp i32 %%length to float, !dbg !5 for 0x%I64xth hint within @mean_calc  --> \n", ++aesl_llvm_cbe_29_count);
  llvm_cbe_tmp__7 = (float )((float )(signed int )llvm_cbe_length);
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__7, *(int*)(&llvm_cbe_tmp__7));
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = fdiv float %%.lcssa, %%8, !dbg !5 for 0x%I64xth hint within @mean_calc  --> \n", ++aesl_llvm_cbe_30_count);
...
printf("\n\{ BEGIN @ksqi_calc\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call float @mean_calc(float* %%data, i32 %%length), !dbg !4 for 0x%I64xth hint within @ksqi_calc  --> \n", ++aesl_llvm_cbe_46_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store float %%1, float* @mean, align 4, !dbg !4 for 0x%I64xth hint within @ksqi_calc  --> \n", ++aesl_llvm_cbe_47_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = fmul float %%8, %%8, !dbg !6 for 0x%I64xth hint within @ksqi_calc  --> \n", ++aesl_llvm_cbe_63_count);
...
const char* AESL_DEBUG_TRACE = getenv("DEBUG_TRACE");
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @overlay_fea_hw_stub\n");
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @overlay_fea(float* %%data, i32 %%length, float* %%kSQI), !dbg !4 for 0x%I64xth hint within @overlay_fea_hw_stub  --> \n", ++aesl_llvm_cbe_109_count);
   /*tail*/ overlay_fea((float *)llvm_cbe_data, llvm_cbe_length, (float *)llvm_cbe_kSQI);
if (AESL_DEBUG_TRACE) {
printf("\nArgument length = 0x%X",llvm_cbe_length);
}
  if (AESL_DEBUG_TRACE)
      printf("\nEND @overlay_fea_hw_stub}\n");
  return;
}
...
const char* AESL_DEBUG_TRACE = getenv("DEBUG_TRACE");
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @apatb_overlay_fea_sw\n");
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @apatb_overlay_fea_ir(float* %%data, i32 %%length, float* %%kSQI) nounwind, !dbg !4 for 0x%I64xth hint within @apatb_overlay_fea_sw  --> \n", ++aesl_llvm_cbe_117_count);
   /*tail*/ apatb_overlay_fea_ir((float *)llvm_cbe_data, llvm_cbe_length, (float *)llvm_cbe_kSQI);
if (AESL_DEBUG_TRACE) {
printf("\nArgument length = 0x%X",llvm_cbe_length);
}
  if (AESL_DEBUG_TRACE)
      printf("\nEND @apatb_overlay_fea_sw}\n");
  return;
}
