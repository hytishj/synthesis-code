...
void apatb_overlay_fea_sw(float *, signed int , float *);
...
static  char aesl_internal__OC_str2[68] = "\xE2\x80\xA6\xE2\x80\xA6\xE2\x80\xA6\xE2\x80\xA6\xE2\x80\xA6\xE2\x80\xA6\xE2\x80\xA6\xE2\x80\xA6\xE2\x80\xA6\xE2\x80\xA6\xE2\x80? time=%f \xE2\x80\xA6\xE2\x80\xA6\xE2\x80\xA6\xE2\x80\xA6\xE2\x80\xA6\xE2\x80\xA6\xE2\x80\xA6\xE2\x80?\n";
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @apatb_overlay_fea_sw(float* %%0, i32 2000, float* %%fea_1) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_29_count);
  apatb_overlay_fea_sw((float *)llvm_cbe_tmp__1, 2000u, (float *)(&llvm_cbe_fea_1));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",2000u);
}
if (AESL_DEBUG_TRACE)
