...
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/Vivado2021.3/Vitis_HLS/2021.2/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);E:/Vivado2021.3/Vitis_HLS/2021.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/Vivado2021.3/Vitis_HLS/2021.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/Vivado2021.3/Vitis_HLS/2021.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "overlay_fea.autotvin.dat"
	set constFileTvOut       "overlay_fea.autotvout.dat"
	set constFileHdlTvIn     "overlay_fea.autohdltvin.dat"
	set constFileHdlTvOut    "overlay_fea.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
