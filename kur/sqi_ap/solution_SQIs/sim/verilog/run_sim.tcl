...
if {[file isfile overlay_fea.autotvin.dat]} {
	file delete -force overlay_fea.autotvin.dat
}

if {[file isfile overlay_fea.autotvout.dat]} {
	file delete -force overlay_fea.autotvout.dat
}
